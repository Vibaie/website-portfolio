...
function createTextTexture(gl, text, font = 'bold 24px monospace', color = '#ffffff') {
  ...
  // Add semi-transparent dark background pill behind text for legibility
...
class Title {
  constructor({ gl, plane, renderer, text, textColor = '#ffffff', font = 'bold 24px monospace' }) {
    autoBind(this);
    this.gl = gl;
    this.plane = plane;
...
export class CircularGallery {
  ...
  addEventListeners() {
    ...
    // Bind interaction listeners directly to the element container for scoped drag and scrolling!
