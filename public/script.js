document.addEventListener('DOMContentLoaded', () => {
    ...
    /* =========================================
       ...
       Violet / Indigo / Cyan palette on certificate cards
       ========================================= */
    (function initCertGlow() {
        document.querySelectorAll('.cert-card').forEach(card => {
            ...
            card.addEventListener('pointermove', (e) => {
                ...
                // Outer glow — violet/indigo/cyan
                if (glowOp > 0) {
                    card.style.boxShadow = [
                        `0 0 18px 2px rgba(192,132,252,${(glowOp * 0.55).toFixed(2)})`,
                        `0 0 35px 4px rgba(129,140,248,${(glowOp * 0.30).toFixed(2)})`,
                        `0 0 60px 8px rgba(56,189,248,${(glowOp  * 0.12).toFixed(2)})`
                    ].join(', ');
                } else {
