...
const DEFAULT_EFFECT_OPTIONS = {
  ...
  colors: {
    ...
    leftCars: [0xff102a, 0xe10600, 0xff2e2e],
    rightCars: [0xffffff, 0xdddddd, 0xcccccc],
    sticks: 0xff102a
  }
};
...
function initHyperspeed() {
  ...
  // Resolve distortion string to actual distortion object
